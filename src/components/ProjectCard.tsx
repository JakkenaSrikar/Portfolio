  ...
  return (
    <div className="group relative flex flex-col h-full rounded-2xl border border-zinc-800/80 bg-zinc-950/40 overflow-hidden transition-all duration-300 hover:border-blue-500/40 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/5">
      ...
      <div className="flex flex-col flex-grow p-6">
        ...
        {/* Actions Button Row */}
        <div className="flex items-center gap-2 mt-6 pt-4 border-t border-zinc-900/80">
          <Link
            href={`/projects/${project.slug}`}
            className="flex-1 inline-flex items-center justify-center px-3.5 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl transition-all shadow-md hover:shadow-blue-500/20 active:scale-95 group/btn"
          >
            Details
          ...
          {project.demoUrl && (
            <a
              ...
              className="flex-1 inline-flex items-center justify-center px-3.5 py-2 text-xs font-bold text-green-400 bg-green-500/10 border border-green-500/25 hover:bg-green-500/20 rounded-xl transition-all active:scale-95"
            >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center p-2 text-zinc-400 hover:text-white bg-zinc-900 border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800 rounded-xl transition-colors"
